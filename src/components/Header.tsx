        ...
        <div className="header__right">
          <button className="header__notification" aria-label="Notifications">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M15 6.5C15 5.11929 14.4732 3.79514 13.5355 2.85786C12.5979 1.92057 11.2737 1.39404 9.89286 1.39404C8.51201 1.39404 7.18786 1.92057 6.25058 2.85786C5.31329 3.79514 4.78676 5.11929 4.78676 6.5C4.78676 12.5 2.5 14 2.5 14H17.5C17.5 14 15 12.5 15 6.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M11.4419 17.5C11.2952 17.7526 11.0849 17.9622 10.8319 18.1079C10.5789 18.2537 10.2922 18.3304 10 18.3304C9.70781 18.3304 9.42106 18.2537 9.16808 18.1079C8.9151 17.9622 8.70479 17.7526 8.55811 17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          
          <button className="header__messages" aria-label="Messages">
            {/* <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M6 10L8 12L14 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className="header__right__inner">
            ...
            <button className="header__menu" aria-label="Menu">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <path d="M3 12H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
