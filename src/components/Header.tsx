...
export const Header: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (isDropdownOpen || isAppsDropdownOpen) {
  ...
  }, [isDropdownOpen, isAppsDropdownOpen]);
    ...
    <header className="header">
      <div className="header__container">
        ...
        <nav className="header__nav">
          ...
          <div className="nav-link-wrapper" ref={appsDropdownRef}>
            <button
              className={`nav-link nav-link--apps ${
                isAppsDropdownOpen ? "nav-link--active" : ""
              }`}
            ...
            >
              ...
              {isAppsDropdownOpen && (
                <>
                <span className="sr-only">Link in Bio</span>
                  <svg
            ...
            {isAppsDropdownOpen && (
              <div className="apps-dropdown" role="menu" aria-label="Apps menu">
                <div className="apps-dropdown__item" role="menuitem">
                  <div className="apps-dropdown__icon">
                  ...
                  <div className="apps-dropdown__content">
                    <div className="apps-dropdown__title">Link in Bio</div>
                    <div className="apps-dropdown__description">
                      Manage your Link in Bio
                    </div>
                  </div>
                  <button
                    className="apps-dropdown__info"
                    aria-label="More info"
                  >
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path
                        d="M10 1.66667C5.39763 1.66667 1.66667 5.39763 1.66667 10C1.66667 14.6024 5.39763 18.3333 10 18.3333C14.6024 18.3333 18.3333 14.6024 18.3333 10C18.3333 5.39763 14.6024 1.66667 10 1.66667Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                ...
                <div className="apps-dropdown__item" role="menuitem">
                  ...
                  <div className="apps-dropdown__content">
                    <div className="apps-dropdown__title">Store</div>
                    <div className="apps-dropdown__description">
                ...
                <div className="apps-dropdown__item" role="menuitem">
                  ...
                  <div className="apps-dropdown__content">
                    <div className="apps-dropdown__title">Media Kit</div>
                    <div className="apps-dropdown__description">
                ...
                <div className="apps-dropdown__item" role="menuitem">
                  ...
                  <div className="apps-dropdown__content">
                    <div className="apps-dropdown__title">Invoicing</div>
                    <div className="apps-dropdown__description">
                ...
                <div className="apps-dropdown__item" role="menuitem">
                  ...
                  <div className="apps-dropdown__content">
                    <div className="apps-dropdown__title">Bookings</div>
                    <div className="apps-dropdown__description">
              ...
              >
                ...
                <div className="header__dropdown__menu">
                  ...
                  <button className="dropdown-menu-item" role="menuitem">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path
                        d="M4.16667 5.83333H15.8333V15.8333C15.8333 16.2754 15.6577 16.6993 15.3452 17.0118C15.0326 17.3244 14.6087 17.5 14.1667 17.5H5.83333C5.39131 17.5 4.96738 17.3244 4.65482 17.0118C4.34226 16.6993 4.16667 16.2754 4.16667 15.8333V5.83333Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M13.3333 2.5H6.66667C6.20643 2.5 5.83333 2.8731 5.83333 3.33333V5.83333H14.1667V3.33333C14.1667 2.8731 13.7936 2.5 13.3333 2.5Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M8.33333 9.16667V13.3333"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                      />
                  ...
                  <button className="dropdown-menu-item" role="menuitem">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      ...
                      />
                      <path
                        d="M11.6667 5H15V8.33333H11.6667V5Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M5 11.6667H8.33333V15H5V11.6667Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M11.6667 11.6667H15V15H11.6667V11.6667Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                    </svg>
                  ...
                  <button className="dropdown-menu-item" role="menuitem">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path
                        d="M13.3333 5.83333C13.3333 7.67428 11.8409 9.16667 10 9.16667C8.15905 9.16667 6.66667 7.67428 6.66667 5.83333C6.66667 3.99238 8.15905 2.5 10 2.5C11.8409 2.5 13.3333 3.99238 13.3333 5.83333Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M10 11.6667C6.31814 11.6667 3.33333 14.6515 3.33333 18.3333H16.6667C16.6667 14.6515 13.6819 11.6667 10 11.6667Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                    </svg>
